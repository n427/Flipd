  ...
  return <SafeAreaView style={{ flex: 1, backgroundColor: T.bg }} edges={['top']}>
    <View style={{ paddingHorizontal: S.gutter, paddingTop: S.screenTop, flex: 1 }}>
      ...
      <View style={{ flexDirection: 'row', gap: 8, marginTop: 16 }}>
        <Field accessibilityLabel="Search Wanted posts" value={query} onChangeText={setQuery} placeholder="Search campus requests" returnKeyType="search" style={{ flex: 1, height: 46, paddingHorizontal: 14, fontFamily: F.medium, fontSize: 15, color: T.ink, backgroundColor: T.fieldbg, borderRadius: 13 }} containerStyle={{ flex: 1 }} />
